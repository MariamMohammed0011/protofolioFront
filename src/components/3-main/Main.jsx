        ...
        <AnimatePresence>
          {projects.map((item) => (
            <motion.article key={item.id} className="card"
              ...
              animate={{ transform: "scale(1)" }}
              transition={{ type: "spring", damping: 8, stiffness: 50 }}>
              <img src={`https://protofolioback-production.up.railway.app/https://protofolioback-production.up.railway.app/storage/images/${item.imgPath}`} width={240} alt={item.projectTitle} className="image-projects" />
